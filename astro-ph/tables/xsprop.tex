...
$^{b}$ The quoted error on SFR is logarithmic because it contains the error in the dust correction. The derived SFR further has a lower ceiling, because of the physical condition that $A_V > 0$\,mag. The lower ceiling is given through SFR$_{\rm min} = 4.8 \times \rm{F_{{H}\alpha, 42}}$.\\}
\end{minipage}
